...
public class mainBoard {
	...
	private void initialize() {
		...
		friendListBT.setFont(new Font("HY?????", Font.BOLD, 12));
		...
		searchFriendBT.setFont(new Font("HY?????", Font.BOLD, 15));
		...
		chattRoomBT.setFont(new Font("HY?????", Font.BOLD, 15));
		...
		JLabel lblApiData0 = new JLabel(data[0][0] + " : " + data[0][1] + "℃");
		...
		searchBT.setFont(new Font("HY?????", Font.BOLD, 17));
		...
		searchText.setFont(new Font("HY?????", Font.PLAIN, 17));
